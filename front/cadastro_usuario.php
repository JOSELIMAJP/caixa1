    ...
    */
    ...
    $vr1= $dados['Saldo'];
        ...
        */
            ...
            ?></p>
            <form name="form1" method="post" onsubmit="return valida()" action="cadastro_usuario_registrar.php">
      ...
      <label for="textfield"></label>
              ...
              <p>Usuario:</p>
              <p>
      <input type="text" inputmode="decimal" name="usuario" id="usuario">
              </p>

              <p>Senha:</p>
              <p>
      <input type="password" inputmode="" name="senha" id="senha">
              </p>
              </p>
              <p>&nbsp;</p>
              <p>
